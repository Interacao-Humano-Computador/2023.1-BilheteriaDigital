...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| [Personas](../../../../analise-de-requisitos/personas)                                                                                                                                                                          | [Douglas Alves](https://github.com/dougAlvs)     |
| [Aspectos Éticos](../../../../analise-de-requisitos/aspectos-eticos) e [Cenários](../../../../analise-de-requisitos/cenarios)                                                                                                   | [Geovanna Maciel](https://github.com/manuziny)   |
| [Perfil de Usuário](../../../../analise-de-requisitos/perfil-usuario) e Análise de Tarefas([HTA](../../../../analise-de-requisitos/analise-de-tarefas/hta) e [GOMS](../../../../analise-de-requisitos/analise-de-tarefas/goms)) | [Matheus Henrique](https://github.com/mathonaut) |
...
Em relação aos itens de verificação, as questões 6 a 15 foram retiradas da checklist de [verificação da etapa 2 do grupo 2](../../../grupo2/etapa2/personas).<a href="#REF6"><sup>6</sup></a>A questão 16 foi baseada na [checklist](https://interacao-humano-computador.github.io/2023.1-ISSNet/verificacao/pc2/#verificacao-personas) que o grupo 8 elaborou na verificação do nosso grupo e se baseia na definição de persona de Cooper (2007, p. 75)<a id=anchor_5  href="#REF5"><sup>5</sup></a>.
