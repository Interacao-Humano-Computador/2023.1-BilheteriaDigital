...
O objetivo deste documento é verificar se os artefatos produzidos na Etapa 4 do [Grupo 1](https://github.com/Interacao-Humano-Computador/2023.1-BilheteriaDigital) possuem os itens e o padrão exigidos para tais.
...
- O [**Relato de Resultados da Avaliação do Storyboard**](https://interacao-humano-computador.github.io/2023.1-BilheteriaDigital/design-avaliacao-desenvolvimento/nivel-1/storyboard-dad/relato-resultado-storyboard/) na versão 1.1 de data 29/05/2023 produzida por [Gabriel Campello](https://github.com/G16C) e revisada por [Arthur de Melo](https://github.com/arthurmlv);
...
A tabela 4 a seguir apresenta a checklist referente aos itens exigidos para o resultados da avaliação. Essa checklist também será utilizada para a análise de tarefas, sendo modificado apenas o nome da tabela no momento de apresentação.
...
A tabela 6 a seguir apresenta a checklist referente aos itens exigidos para o relato dos resultados segundo Barbosa e Silva (2011, p.358-362).<a href="#REF1"><sup>1</sup></a>
