# Verificação do Planejamento da Avaliação do Protótipo de Papel do Grupo 2
...
|       7.4        | O documento possui os participantes da avaliação?                                                      | Incompleto | Não está explícito.                                                   |
