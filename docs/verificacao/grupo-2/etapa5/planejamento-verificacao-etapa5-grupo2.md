...
O objetivo deste documento é verificar se os artefatos produzidos na entrega 5 do [grupo 2](https://interacao-humano-computador.github.io/2023.1-Wikipedia/) possuem os itens e o padrão exigidos para tais.
...
- O [**Planejamento da Avaliação do StoryBoard**](https://interacao-humano-computador.github.io/2023.1-Wikipedia/design-avaliacao-desenvolvimento/nivel1/storyboard/planejamentoDaAvaliacao/) na versão 1.1 de data 27/05/2023 produzido por [Pedro Henrique](https://github.com/PedroHenrique2077), [Ana Luiza](https://github.com/analuizargds) e [Lucas Lopes](https://github.com/LucasLopesFrazao) com revisão de [Chaydson Ferreira](https://github.com/chaydson), [Pedro Henrique](https://github.com/PedroHenrique2077) e [Samuel Gomes](https://github.com/SamuelGSouza);
- O [**Planejamento do relato dos resultados da avaliação do Storyboard**](https://interacao-humano-computador.github.io/2023.1-Wikipedia/design-avaliacao-desenvolvimento/nivel1/storyboard/planejamentoResultadosAvaliacaoStoryboard/) na versão 1.0 de data 21/05/2023 produzido por [Chaydson Ferreira](https://github.com/chaydson) com revisão de [Gabriel Ferreira](https://github.com/oo7gabriel);
...
- O [**Planejamento de Avaliação de Tarefas**](https://interacao-humano-computador.github.io/2023.1-Wikipedia/design-avaliacao-desenvolvimento/nivel1/analiseDeTarefas/planejamentoDaAvaliacaoTarefas/) na versão 1.1 de data 28/05/2023 produzido por [Gabriel Ferreira](https://github.com/oo7gabriel) e [Samuel Gomes](https://github.com/SamuelGSouza) com revisão de [Lucas Lopes](https://github.com/LucasLopesFrazao);
- O [**Planejamento dos resultados das Análises de Tarefas**](https://interacao-humano-computador.github.io/2023.1-Wikipedia/design-avaliacao-desenvolvimento/nivel1/analiseDeTarefas/planejamentoResultadosAnalisesTarefas/) na versão 1.0 de data 20/05/2023 produzido por [Lucas Lopes](https://github.com/LucasLopesFrazao) com revisão de [Ana Luiza](https://github.com/analuizargds);
...
A verificação será realizada no período de 30 de maio de 2023 até dia 2 de junho de 2023, com os resultados sendo relatados através da página de documentação do Grupo 1 no dia 03 de junho de 2023. A tabela 1 a seguir, apresenta o cronograma das atividades a serem realizadas.
...
| 03/06/2023 | Verificação do Planejamento da Avaliação do Protótipo de Papel e Relato dos resultados da verificação.                     | [Matheus Henrique](https://github.com/mathonaut) |
...
As checklists forao construídas levando em conta os padrões esperados para cada artefato e as principais tarefas realizadas na elaboração dos mesmos, os padrões esperados para.[^1^]() Além dos itens listados anteriormente, também será analisado o relatório referente à entrega 5 produzido pelo o monitor do grupo [Davi Silva](https://github.com/daves22).

Serão ao todo 7 checklists com o intuito de melhor organizar a verificação, sendo que um o geral deverá estar presente em todas as etapas de verificação. As checklists são os seguintes: Geral, Planejamento da Avaliação do Storyboard, Planejamento do Relato da Avaliação do Storyboard, Resultado da Avaliação do Storyboard, Planejamento da Avaliação da Análise de Tarefa, Planejamento do Relato da Avaliação da Análise de Tarefa, Resultado do Relato da Avaliação da Análise de Tarefa, Planejamento da Avaliação do Protótipo de Papel e Planejamento do Relato do Protótipo de Papel. As tabelas de 2 a 9 apresenta as checklists de verificação.
...
A tabela 3 a seguir apresenta a checklist referente aos itens exigidos para o documento de planejamento segundo Barbosa e Silva (2011, p.286-313).[^2^]()

<center>

**Tabela 3** - Checklist para o Planejamento da Avaliação do Storyboard.
...
| 8     | O documento possui os itens a serem avaliados?                                 |           |             |
| 8.1   | Os itens se referem somente aos artefatos e não ao site?                       |           |             |
| 8.2   | Os itens verificam se os artefatos possuem os padrões necessários?             |           |             |
| 8.3   | Os itens verificam quais são as tarefas envolvidas?                            |           |             |
| 8.4   | Os itens verificam quais são os ambientes?                                     |           |             |
| 8.5   | Os itens verificam quais são as pessoas envolvidas?                            |           |             |
| 8.6   | Os itens verificam quais são os passos envolvidos?                             |           |             |
| 8.7   | Os itens verificam qual a motivação de usar a aplicação?                       |           |             |
| 8.8   | Os itens verificam o que é preciso para complementar a tarefa?                 |           |             |
| 8.9   | Os itens verificam o que motivou a usar o sistema?                             |           |             |
| 8.10  | Os itens verificam o resultado da pessoa ao completar a tarefa no final?       |           |             |
| 9     | O documento possui uma seção de teste piloto?                                  |           |             |
| 9.1   | A definição do teste piloto?                                                   |           |             |
| 9.2   | Existe um cronograma com local, data e hora da realização do teste piloto?     |           |             |
| 9.3   | Existe uma gravação do teste piloto?                                           |           |             |
| 9.4   | Quem são os participantes do teste piloto?                                     |           |             |
| 10    | O documento possui os storyboard a serem avaliados?                            |           |             |
| 10.1  | Existe um para cada integrante do grupo?                                       |           |             |
| 10.2  | São referentes às tarefas elucidadas na Análise de Tarefas do grupo?           |           |             |
...
A tabela 4 a seguir apresenta a checklist referente aos itens exigidos para o relato dos resultados segundo Barbosa e Silva (2011, p.312).[^3^]() É importante ressaltar que essa checklist será utilizada também para a análise de tarefas, sendo modificado apenas o nome da tabela no momento de apresentação.

<center>

**Tabela 4** - Checklist para o Planejamento do Relato da Avaliação do Storyboard.

| ID  | Descrição                                                                                     | Avaliação | Observações |
| --- | --------------------------------------------------------------------------------------------- | --------- | ----------- |
| 6   | O documento possui um tópico sobre quais são os objetivos do relato?                          |           |             |
| 7   | O documento possui um tópico sobre a metodologia do relato?                                   |           |             |
| 8   | O documento possui um tópico sobre quais foram os participantes?                              |           |             |
| 9   | O documento possui um tópico sobre o sumario dos dados?                                       |           |             |
| 10  | O documento possui um tópico sobre a analise e interpretacao dos dados?                       |           |             |
| 11  | O documento possui um tópico sobre a lista dos problemas encontrados?                         |           |             |
| 12  | O documento possui um tópico sobre sugestoes e/ou planejamento para a correcao dos problemas? |           |             |
...
A tabela 5 a seguir apresenta a checklist referente aos itens exigidos para o resultados da avaliação segundo a tabela 4 apresentada anteriormente. Essa checklist também será utilizada para a análise de tarefas, sendo modificado apenas o nome da tabela no momento de apresentação.

<center>

**Tabela 5** - Checklist para o Resultado da Avaliação do Storyboard.
...
### Planejamento da Avaliação da Análise de Tarefa

Ela é semelhante ao planejamento da avaliação do storyboard, sendo mudado a questão 10 que passa referenciar agora as tarefas. A tabela 6 a seguir apresenta a checklist referente aos itens exigidos.

<center>

**Tabela 6** - Checklist para o Planejamento da Avaliação da Análise de Tarefa.
...
| 9.3   | Existe uma gravação do teste piloto?                                           |           |             |
| 9.4   | Quem são os participantes do teste piloto?                                     |           |             |
| 10    | Os textos linkam e referenciam as tarefas que serão avaliadas?                 |           |             |
...
Ela é semelhante ao planejamento da avaliação do storyboard e da análise de tarefa, sendo mudado algumas questões para se adequar agora ao protótipo de papel. A tabela 6 a seguir apresenta a checklist referente aos itens exigidos.

<center>

**Tabela 6** - Checklist para o Planejamento da Avaliação do Protótipo de Papel.
...
A tabela x a seguir apresenta a checklist referente aos itens exigidos para o relato dos resultados segundo Barbosa e Silva (2011, p.361-362).[^x^]()

<center>

**Tabela x** - Checklist para o Planejamento do Relato do Protótipo de Papel.

| ID   | Descrição                                                                                             | Avaliação | Observações |
| ---- | ----------------------------------------------------------------------------------------------------- | --------- | ----------- |
| 6    | O documento possui um tópico sobre quais são os objetivos do relato?                                  |           |             |
| 7    | O documento possui um tópico sobre a metodologia de prototipacao de papel?                            |           |             |
| 8    | O documento possui um tópico sobre quais foram os participantes e os eus perfis?                      |           |             |
| 9    | O documento possui um tópico as tarefas executadas pelos participantes;?                              |           |             |
...
| `1.2`  | 03/06/2023 | Correção de perguntas.                 | [Matheus Henrique](https://github.com/mathonaut) | [Arthur de Melo](https://github.com/arthurmlv) |
