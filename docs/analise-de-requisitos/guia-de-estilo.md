...
Os usuários podem interagir com o site na seleção de eventos, seleção de assentos, finalização da compra, confirmação de compra e cancelamento de compra. Os quais são feitos através de botões e/ou _hiperlinks_.
...
Incluem botões, ícones, links e outros elementos clicáveis. No site encontramos elementos como botões de compra, _hyperlinks_ e pagamento.
